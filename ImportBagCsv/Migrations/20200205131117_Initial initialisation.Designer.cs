...
namespace ImportBagCsv.Migrations
{
    ...
    [Migration("20200205131117_Initial initialisation")]
    partial class Initialinitialisation
    {
            ...
            modelBuilder.Entity("ImportBagCsv.Models.Adres", b =>
                {
                    ...
                    b.HasIndex("Postcode")
                        .HasAnnotation("SqlServer:Include", new[] { "Straat" });
            ...
            modelBuilder.Entity("ImportBagCsv.Models.Nummer", b =>
                {
                    ...
                    b.HasIndex("Huisnummer")
                        .HasAnnotation("SqlServer:Include", new[] { "Huisletter", "Huisnummertoevoeging" });
